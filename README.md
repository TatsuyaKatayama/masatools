...
```python
from masatools.skills.common.board import check_board, post_message, create_thread, start_monitoring
...
# メッセージの投稿
await post_message(message="作業が完了しました。成果物をアップロードしました。", output_dir="tasks/{tid}/output/")
```
